...
TEST(LexarTest, FizzBuzz)
{
    static const Kind expected[] = {
        ...
        Kind::LOGIC_TOKEN,      Kind::EOF_TOKEN,        Kind::RPAREN_TOKEN,
        ...
        Kind::RCURLEY_TOKEN,    Kind::KEYWORD_TOKEN,    Kind::LCURLEY_TOKEN,
        Kind::IDENTIFIER_TOKEN, Kind::LPAREN_TOKEN,     Kind::IDENTIFIER_TOKEN,
        Kind::RPAREN_TOKEN,     Kind::RCURLEY_TOKEN,    Kind::RCURLEY_TOKEN,
        Kind::IDENTIFIER_TOKEN, Kind::LCURLEY_TOKEN,    Kind::COMMENT_TOKEN,
        Kind::KEYWORD_TOKEN,    Kind::IDENTIFIER_TOKEN, Kind::OPERATION_TOKEN,
        Kind::LBRACKET_TOKEN,   Kind::INTEGER_TOKEN,    Kind::COMMA_TOKEN,
        Kind::INTEGER_TOKEN,    Kind::RBRACKET_TOKEN,   Kind::LCURLEY_TOKEN,
        Kind::IDENTIFIER_TOKEN, Kind::LPAREN_TOKEN,     Kind::IDENTIFIER_TOKEN,
        Kind::RPAREN_TOKEN,     Kind::RCURLEY_TOKEN,    Kind::RCURLEY_TOKEN,
    };
